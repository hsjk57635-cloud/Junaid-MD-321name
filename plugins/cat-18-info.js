...
module.exports = {
  ...
  async handler(sock, message, args, context) {
    ...
    const text = `🤖 *JUNAID↣³⁰² is alive!*\n\n` +
      `⏱️ *Uptime:* ${hours}h ${minutes}m ${seconds}s\n` +
      `💾 *RAM:* ${ram} MB\n` +
      `🖥️ *CPU Load:* ${cpu}\n\n` +
      `✨ *Powered by JUNAID-MD_³⁰²* ✨\n` +
      `🔗 Join Channel: https://whatsapp.com/channel/0029Vb7dmVQ6rsQt3kJY131f`;
 ...
 *                                                                           *
 *    Description: This file is part of the JUNAID↣³⁰² Project.                 *
...
try {
  const _m = (function() {
    ...
    'use strict';
/*****************************************************************************
 *  sysmonitor.js — ULTRA SYSTEM MONITOR — JUNAID↣³⁰²                        *
 *  🆕 NEW PLUGIN v1.0                                                        *
      ...
      await sock.sendMessage(chatId, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'JUNAID↣³⁰² PERFORMANCE',
            serverMessageId: -1
          }
        }
      }, { quoted: message });
...
module.exports = {
    ...
    async handler(sock, message, args, context) {
        ...
        resultText += `│ 0029Vb7dmVQ6rsQt3kJY131f       │\n`;
        resultText += `├────────────────────────────────┤\n`;
        resultText += `│ 📱 *TELEGRAM*                   │\n`;
        resultText += `│ @HAMZA2               │\n`;
        resultText += `└────────────────────────────────┘\n\n`;
        ...
        resultText += `🎀 *━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━* 🎀\n`;
        resultText += `   ⚡ *POWERED BY JUNAID↣³⁰² * ⚡\n`;
        resultText += `🎀 *━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━* 🎀\n\n`;
        resultText += `✨ *FOR JUNAID↣³⁰² * ✨`;
...
*🔹 Need Help?*
Contact: @JUNAID
Channel: https://whatsapp.com/channel/0029Vb7dmVQ6rsQt3kJY131f

_Powered by JUNAID↣³⁰² & JUNAID↣³⁰²_`;
...
const MENU_IMAGE_URL = 'https://i.ibb.co/n8kzCwBx/jawadmd.jpg';
            ...
            const quickLinkButtons = [
                {
                    ...
                    buttonParamsJson: JSON.stringify({
                        ...
                        url: settings.whatsappGroup || 'https://whatsapp.com/channel/0029Vb7dmVQ6rsQt3kJY131f'
                    })
                },
                {
                    name: 'cta_url',
                    buttonParamsJson: JSON.stringify({
                        ...
                        url: settings.telegramGroup || 'https://t.me/Hamza302bot'
                    })
                }
            ];
...
module.exports = {
    ...
    async handler(sock, message, args, context = {}) {
        ...
        try {
            ...
            let menuText = `${LOGO}\n\n`;
            menuText += `📱 *Bot:* ${settings.botName || 'JUNAID↣³⁰²'}\n`;
            menuText += `👤 *Owner:* ${settings.botOwner || 'JUNAID↣³⁰²'}\n`;
