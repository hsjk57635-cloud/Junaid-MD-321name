...
// Default values
const DEFAULT_BOT_NAME = settings.botName || 'JUNAID-MD_³⁰²';
const DEFAULT_OWNER = settings.botOwner || 'JUNAID-MD_³⁰²';
  ...
  async handler(sock, message, args, context) {
    ...
    const forwardContextInfo = {
      ...
      forwardedNewsletterMessageInfo: {
        ...
        newsletterName: config.botName || 'JUNAID-MD_³⁰²',
        serverMessageId: -1
      }
    };
