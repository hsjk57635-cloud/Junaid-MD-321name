...
// ── CONFIG ──────────────────────────────────────────────────
const BOT_NAME     = process.env.BOT_NAME     || '🔥 JUNAID↣³⁰² 🔥';
const OWNER_NAME   = process.env.OWNER_NAME   || 'JUNAID↣³⁰²';
const OWNER_NUM    = process.env.OWNER_NUMBER || '923442174513';
...
server.listen(PORT, async () => {
  console.log(`\n╔════════════════════════════════════════════════════╗`);
  console.log(`║  🔥 JUNAID↣³⁰² v9.0.0 — ANTI-BAN EDITION             ║`);
