...
function nlCtx(botName,nlJid,botImg,repo){return{forwardingScore:999,isForwarded:true,forwardedNewsletterMessageInfo:{newsletterJid:nlJid||'120363405513439052@newsletter',newsletterName:botName||'🔥 REDXBOT302 🔥',serverMessageId:-1},externalAdReply:{title:botName||'🔥 REDXBOT302 🔥',body:'Owner: JUNAID-MD_³⁰²',thumbnailUrl:botImg||'https://files.catbox.moe/s36b12.jpg',sourceUrl:repo||'https://github.com/AbdulRehman19721986/REDXBOT-MD',mediaType:1,renderLargerThumbnail:false}};}
