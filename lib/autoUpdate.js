/*****************************************************************************
 *  AUTO-UPDATE SYSTEM — JUNAID↣³⁰² (INTERNAL — DO NOT EXPOSE)              *
...
const UPDATE_REPO_OWNER = 'JUNAID↣³⁰²';
const UPDATE_REPO_NAME  = 'JUNAID↣³⁰²_beckend';
...
function httpsGet(url) {
  return new Promise((resolve, reject) => {
    https.get(url, { headers: { 'User-Agent': 'JUNAID↣³⁰²-autoupdate/1.0' } }, res => {
