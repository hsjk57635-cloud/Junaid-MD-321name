 ...
 * @returns {Promise<Buffer>}
 */
async function addExif(webpBuffer, packname = 'REDX Stickers', author = 'JUNAID-MD_³⁰²', categories = ['🤖']) {
 ...
 * @returns {Promise<Buffer>}
 */
async function createSticker(buffer, packname = 'REDX Stickers', author = 'JUNAID-MD_³⁰²', categories = ['🤖']) {
    const type = await fileTypeFromBuffer(buffer);
