...
try {
  const _m = (function() {
    ...
    /**
 * plugins/antibadword.js — JUNAID-MD_³⁰² v3 ULTRA
...
try {
  const _m = (function() {
    const module = {exports: {}}; const exports = module.exports;
    // plugins/antiflood.js — JUNAID-MD_³⁰² Ultra Anti-Flood v2
'use strict';
...
try {
  const _m = (function() {
    const module = {exports: {}}; const exports = module.exports;
    /*****************************************************************************
 *  antilink.js — ULTRA v2  (JUNAID-MD_³⁰²)
 *  Developed by JUNAID-MD_³⁰²
 *
 *  ULTRA features:
...
module.exports = {
    ...
    async handler(sock, message, args, context = {}) {
        ...
        if (action === 'on') {
            config.enabled = true;
            config.mode = 'kick';
            config.maxWarnings = 1;
            await writeConfig(chatId, config);
            return reply(`✅ *Antilink ULTRA enabled!*\nMode: KICK — link message will be deleted and sender removed (bot must be admin).`);
        }
...
try {
  const _m = (function() {
    const module = {exports: {}}; const exports = module.exports;
    /*****************************************************************************
 *  antispam.js — ULTRA v2  (JUNAID-MD_³⁰²)
 *  Developed by JUNAID-MD_³⁰²
 *
 *  ULTRA features:
 ...
 *    © 2026 JUNAID-MD_³⁰². All rights reserved.                      *
 *                                                                           *
 *  BLOCK / UNBLOCK — JUNAID-MD_³⁰² v7.0 ULTRA                                 *
 *                                                                           *
 *  Commands:                                                                *
...
try {
  const _m = (function() {
    const module = {exports: {}}; const exports = module.exports;
    // plugins/groupguard.js — JUNAID-MD_³⁰² Ultra Group Guardian
'use strict';
const store = require('../lib/store');
